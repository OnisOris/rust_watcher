...
const ALL_NODE_TYPES: NodeType[] = ['File', 'Module', 'Struct', 'Class', 'Enum', 'Trait', 'Impl', 'Function', 'Method', 'Component', 'Hook', 'Interface', 'TypeAlias', 'Endpoint', 'Macro', 'ExternalCrate']
